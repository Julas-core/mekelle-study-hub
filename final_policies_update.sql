...
-- For update and delete, restrict to only the uploader
...
-- This will allow users to upload to the course-materials bucket
CREATE POLICY "Allow all users to upload course materials" ON storage.objects
FOR INSERT TO authenticated
WITH CHECK (bucket_id = 'course-materials');

-- For update/delete operations, restrict to authenticated users for the course-materials bucket
-- More permissive approach while maintaining basic security
